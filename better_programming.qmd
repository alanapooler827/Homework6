...
2.  Fit a number of different models with the code below!
...
4.  Create histograms of the residuals in each model fit
...
5.  Update histograms to have appropriate names
